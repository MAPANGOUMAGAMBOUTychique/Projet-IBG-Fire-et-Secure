...
<head>
    ...
    <title>Postulation employer</title>
...
<section class="container">
        <section class="colonne-gauche">
            <h2>Nom de l'entreprise ou du Particulier</h2>
            <h3>Description</h3>
    ...
    <section class="colonne-droite">
        ...
        <section id="Document_candidature">
            ...
            <button type="submit" class="btn-submit">Postuler</button>
    ...
    <section class="reponse">
        ...
        <p>Votre candidature a été envoyer avec succès !</p>
    </section>
    </main>
    <footer>
        <ul>

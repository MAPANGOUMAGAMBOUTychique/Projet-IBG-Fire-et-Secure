...
<head>
    ...
    <title>Services | Site IBG FIRE ET SECURE</title>
...
<main>
    ...
    <div class="content-box">
        <table>
            ...
            <tbody>
                <tr>
                    <td class="service-name">Service1</td>
                    <td class="count">14</td>
                </tr>
                <tr>
                    <td class="service-name">Service2</td>
                    <td class="count">14</td>
                </tr>
                <tr>
                    <td class="service-name">Service3</td>
                    <td class="count">14</td>
                </tr>
                <tr>
                    <td class="service-name">Service4</td>
                    <td class="count">14</td>
                </tr>
            </tbody>
        </table>

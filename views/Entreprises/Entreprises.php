...
<head>
    ...
    <title>Entreprises | Site IBG FIRE ET SECURE</title>
...
<main>
    ...
    <div class="content-box">
        <table>
            <thead>
                <tr>
                    <th></th> 
                    <th class="header-count">Nombre de missions<br>sollicitées</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td class="company-name">Nom Entreprise1</td>
                    <td class="count">14</td>
                </tr>
                <tr>
                    <td class="company-name">Nom Entreprise2</td>
                    <td class="count">14</td>
                </tr>
                <tr>
                    <td class="company-name">Nom Entreprise3</td>
                    <td class="count">14</td>
                </tr>
                <tr>
                    <td class="company-name">Nom Entreprise4</td>
                    <td class="count">14</td>
                </tr>
            </tbody>
        </table>
    ...
    <div class="footer-action">
        <a href="SeConnecter.html" class="logout-link">Se déconnecter</a>
    </div>
</main>
</body>
    <footer>

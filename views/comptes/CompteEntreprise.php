...
if (!isset($_SESSION['user_role']) || $_SESSION['user_role'] !== 'entreprise') {
    ...
    <main>
        ...
        <section id="Compte_entreprise">
            <form action="" method="post" class="formulaire">
                ...
                <a href="#Modification_compte"><button type="submit" class="btn-submit">Modifier</button></a>             
            </form>
        </section>

        <section id="Modification_compte">
            <p>Voulez vous vraiment modifier vos informations ?</p>
            <a href="#Compte_modifier"><button type="submit" class="btn-submit">Oui</button></a>
            <a href="#Compte_entreprise"><button type="submit" class="btn-submit">Non</button></a>
        </section>

         

        <p id="Compte_modifier">Informations modifier !</p>
        ...
        <section id="services">
                ...
                <ul class="service-grid">
                    ...
                    <li>
                        <article>
                                ...
                                <a href="PostulationEmployer.html" class="btn-solliciter" >Solliciter</a>
                        </article>
            ...
            <section id="Supression_compte_entreprise">
                ...
                <div class="oui-non">
                    <a href="#Compte_entreprise_suprimer"><button class="btn-solliciter">Oui</button></a>
                    <a href="#Modification_compte"><button class="btn-solliciter">Non</button></a>
                </div>

...
// session_start() initialise ou réactive la session courante.
// Obligatoire sur toutes les pages nécessitant de vérifier le statut de connexion de l'utilisateur.
if (session_status() === PHP_SESSION_NONE) {
    session_start();
}

// Inclusion sécurisée du script de gestion de la base de données.
require_once 'Database.php';

// Directives d'affichage des erreurs PHP. Idéal pour le développement afin de repérer immédiatement un bug.
ini_set('display_errors', 1);
ini_set('display_startup_errors', 1);
error_reporting(E_ALL);

// Définition de la constante d'URL absolue pour centraliser et sécuriser les chemins d'accès aux fichiers.
                ...
                <ul class="service-grid">
                    ...
                    <li class="reveal-items">
                        <article>
                            ...
                            <img src="assets/image/Evacuation-1663075966038-6b37cc036924.avif" alt="Image Formation d'exercice d'evacuation">
                            <p>La préparation est la clé d'une gestion effective des situations d'urgence. Nous formons vos équipes à adopter les bons réflexes et organisons des exercices d'évacuation grandeur nature pour tester vos procédures. En cas d'alerte, chaque seconde compte : nous vous vous aidons à bâtir une organisation fluide et sécurisée pour protéger toutes les personnes présentes dans vos locaux.</p>
                        </article>
                    </li>
                </ul>
            </section>
